<?php get_header(); ?>
		...
		<!-- Section Start -->
		<section class="blog" id="archive">
		
		<?php $chloe_i=0; if (have_posts()) : ?>
		
			<h2 class="page-heading"><?php chloe_archive_title(); ?></h2>
			...
			<?php chloe_kriesi_pagination(); ?>
				...
				<?php else : ?>
					...
					<h2 class="page-heading"><?php _e('Nothing found', 'chloe'); ?></h2>
					<div class="no-search-result">
						<?php _e('Nothing found', 'chloe'); ?>.
					</div>
