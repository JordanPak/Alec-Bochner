...
jQuery(document).ready(function($){
	...
	jQuery('#chloe_background_patterns').on('change', function (e) {
    var optionSelected = $("option:selected", this);
    var Selected_pattern = this.value;
	if(Selected_pattern != ""){
		jQuery("#wpbody-content").css("background","url("+ch_dir+"/patterns/"+Selected_pattern+".png)");
	}
	});

	jQuery(".of-info .chloe_description").each(function () {
		jQuery(this).parent().addClass("chloe_description_info");
	});
